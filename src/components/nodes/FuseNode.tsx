...
export function FuseNode({ data, selected }: any) {
    ...
    return (            <div className={`bg-slate-900 border-2 rounded-lg w-20 flex flex-col items-center shadow-lg relative transition-all ${selected ? 'border-blue-500 shadow-[0_0_15px_rgba(59,130,246,0.5)]' : isBlown ? 'border-red-500/80 shadow-[0_0_15px_rgba(239,68,68,0.3)]' : 'border-slate-700 hover:border-slate-500'}`} >
