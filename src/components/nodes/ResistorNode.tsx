...
export function ResistorNode({ data, selected }: any) {
    ...
    return (
        <div className={`bg-slate-900 border-2 rounded-lg w-20 h-14 flex flex-col items-center justify-center shadow-lg relative transition-all ${selected ? 'border-blue-500 shadow-[0_0_15px_rgba(59,130,246,0.5)]' : 'border-slate-700 hover:border-slate-500'}`}>
