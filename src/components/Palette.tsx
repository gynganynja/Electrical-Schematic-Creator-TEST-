...
const PALETTE_ITEMS: PaletteItemProps[] = [
    ...
    { type: 'throttle_actuator', label: 'Throttle Actuator', icon: <Wind size={18} /> },
...
const SECTIONS: { label: string; types: string[] }[] = [
    ...
    { label: 'Loads / Outputs', types: ['lamp', 'led', 'resistor', 'motor', 'buzzer', 'solenoid', 'heater', 'compressor_clutch', 'wiper_motor', 'ignition_coil', 'throttle_actuator'] },
